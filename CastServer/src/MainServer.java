...
public class MainServer extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Server İnitializon Port");
        ...
        jLabel1.setText("Sound Port:");

        jLabel3.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        jLabel3.setText("Video Port:");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        String text = jTextField1.getText();
            ...
            Integer port2 = Integer.parseInt(text2);
            portnumbers = new int[2];
            portnumbers[0]=port;
            portnumbers[1]=port2;
            CServer server = new CServer(portnumbers);
